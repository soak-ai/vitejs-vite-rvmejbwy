...
@keyframes cardSeal { 0%{box-shadow:0 0 0 0 var(--seal-color)} 40%{box-shadow:0 0 0 8px var(--seal-color)} 70%{box-shadow:0 0 0 14px rgba(0,0,0,0)} 100%{box-shadow:0 0 0 0 rgba(0,0,0,0)} }
@media (max-width: 700px) {
  .card-sealing { animation: cardSeal 1.2s ease-out both; }
}
